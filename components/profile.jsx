...
const ProfileDetails = (props) => {
    return (
      <div>
        ...
        <div class = "row">
          <div class="col-md-8 "> {props.infoclean.public_repos ? <div><p>Public repositories: {props.infoclean.public_repos}</p></div> : null } </div>
        </div>
        <div class = "row">
        ...
        <div class = "row">
          <div class="col-md-8 ">{props.infoclean.html_url ? <div><p><a href={props.infoclean.html_url} target="_blank">View profile on Github</a></p></div> : null } </div>
        </div>
      </div>
    )};
